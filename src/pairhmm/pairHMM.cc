...
void PairHMM::Initialization() {
    ...
    match_matrix_.resize(pad_read_length_ * pad_max_haplotype_length_, 0.0);
    insert_matrix_.resize(pad_read_length_ * pad_max_haplotype_length_, 0.0);
    delete_matrix_.resize(pad_read_length_ * pad_max_haplotype_length_, 0.0);
