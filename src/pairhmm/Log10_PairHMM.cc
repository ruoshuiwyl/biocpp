...
void Log10_PairHMM::Initialization() {
    match_matrix_.resize(pad_max_read_length_ * pad_max_haplotype_length_, DBL_MIN);
    insert_matrix_.resize(pad_max_read_length_ * pad_max_haplotype_length_, DBL_MIN);
    delete_matrix_.resize(pad_max_read_length_ * pad_max_haplotype_length_, DBL_MIN);
}
